...
Com o Node-RED é possível monitorar a comunicação entre os componentes IoT que compõem o projeto, registrar as leituras em bancos de dados MySQL e fornecer um [painel de monitoramento e comando (dashboard)](https://images.app.goo.gl/g6BLzrgdrtGrNHdDA). <br>
