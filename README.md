...
Com o Node-RED é possível monitorar a comunicação entre os componentes IoT que compõem o projeto, registrar as leituras em bancos de dados MySQL e fornecer um (https://i.sstatic.net/ScBty.png) [painel de monitoramento e comando (dashboard)](http://54.172.232.108:1880/ui/#!/0?socketid=hmuC3YyTJUfVylQFAACB). <br>
